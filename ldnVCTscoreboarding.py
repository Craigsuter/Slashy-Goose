...
def ldnvctscoreboarding():
  ...
  f.close()
  upload_file('/ldnvctscoreboard.csv', 'Scoreboard.csv')
  



def ldnvctscoreboardreader(pagenumber):
...
def ldnvctscoreboardsingle(userID):
...
def ldnvctscoreboardadder(usersname, userID, scoretoadd, counter):
  i=0
  filenames = ["accountname", "userIDs", "score"]
